(function() {
    ...
    */
    ...
    var R = function(a, b, c) {
        ...
        T = function(a, b, c) {
            b && b.length > 0 && (b = sa(b), c && c.length > 0 && (b += "___" + sa(c)), b.length > 28 && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = J(qa, "_p", K()), J(b, c, K())[a] = (new Date).getTime(), R(a, "_p", c))
        },
        sa = function(a) {
    ...
    U.push(["jsl", function(a) {
        ...
        if (b = a.u) a = J(O, "us", []), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push("http:" + b[1])
    }]);
    var ua = /^(\/[a-zA-Z0-9_\-]+)+$/,
        va = [/\/amp\//, /\/amp$/, /^\/amp$/],
        wa = /^[a-zA-Z0-9\-_\.,!]+$/,
    ...
    var X = decodeURI("%73cript"),
        ...
        Ia = function() {
            var a = O.nonce;
            return a !== void 0 ? a && a === String(a) && a.match(Ga) ? a : O.nonce = null : I.querySelector ? (a = I.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(Ga) ? O.nonce = a : O.nonce = null) : null : null
        },
        Ka = function(a) {
    ...
    var Y = Pa;
    var La = function(a, b) {
        if (O.hee && O.hel > 0) try {
            return a()
        } catch (c) {
            b && b(c), O.hel--, Oa("debug_error", function() {
                try {
    ...
    window.gapi.load("", {
        ...
        _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en.pGGAptgAK4s.O/am=AAAg/d=1/rs=AHpOoo-Cic-4VdRMZ7mFCYOA3wzpF7O-6g/m=__features__",
